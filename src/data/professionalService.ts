...
const rawProfessionalService = [
	...
	{
		title: "IEEE Industry Connections Program on Ethical Assurance of Data-Driven Technologies for Mental Healthcare",
		role: "Chair",
...
export const professionalService = [...rawProfessionalService].sort(orderElementsByTime);
