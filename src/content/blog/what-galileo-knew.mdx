...
You vary the angle of the plank and the pattern holds. Steeper angles produce faster motion, but the *form* of the relationship is identical. That is, distance always goes as $t^2$. You try different balls and get the same result.
...
We know all this not just from the polished account Galileo published decades later in his [*Discorsi*](https://plato.stanford.edu/entries/galileo/) (1638), but from his unpublished working papers, such as the [folios of Codex 72](http://www.imss.fi.it/ms72/INDEX.HTM), preserved in Florence, which record his experiments as they actually happened. (The standard scholarly account of these folios is [Stillman Drake's](https://openlibrary.org/books/OL4718449M/Galileo_at_work) *Galileo at Work*; the mathematical reconstruction I draw on here is [Hahn's](https://math.nd.edu/assets/20636/ahes.pdf).)

One folio in particular (116v) reveals the three-phase structure of scientific reasoning with extraordinary clarity.

![Galileo's folio 116v, Codex 72, Biblioteca Nazionale Centrale, Florence.](/images/blog/galileo-series/folio-116v.png)
*Galileo's folio 116v, Codex 72, Biblioteca Nazionale Centrale, Florence.*
...
What Galileo's successes and failures together reveal is a structure of scientific reasoning that I want to decompose into three distinct phases, each playing a different epistemic role. This is my own framework for the purposes of this series, and it should be noted that other decompositions exist, such as [Peirce's](https://plato.stanford.edu/entries/abduction/) triadic account of abduction, deduction, and induction, or the [hypothetico-deductive model](https://plato.stanford.edu/entries/scientific-method/). However, the three-phase structure maps most directly onto the AI capabilities I'll discuss in later posts.

First, there an **exploratory** phase, comprising gathering data, running experiments, noticing the $t^2$ regularity. This is where careful observation and measurement do their work.
