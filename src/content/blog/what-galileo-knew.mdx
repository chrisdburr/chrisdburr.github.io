...
<figure>
  <Image src="/images/blog/galileo-series/folio-116v-composite.png" alt="Galileo's folio 116v (left) alongside Hahn's reconstruction (right), showing parabolic trajectory diagrams, columns of measured and predicted distances, and the 'doveria esser' annotations circled in orange." width={700} height={472} />
  <figcaption>Folio 116v, Codex 72, Biblioteca Nazionale Centrale, Florence (left) alongside <a href="https://math.nd.edu/assets/20636/ahes.pdf">Hahn's</a> reconstruction (right). The circled annotation reads <em>doveria esser</em> ("ought to be").</figcaption>
</figure>
...
<figure>
  <Image src="/images/blog/galileo-series/folio-081r.jpg" alt="Galileo's folio 81r, showing careful trajectory diagrams and measurements in the upper half, with the lower half conspicuously blank where the analysis should have been." width={500} height={686} />
